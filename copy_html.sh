...
for html in docs/html/{*.html,*/*.html} ; do
    ...
    sed -E 's/(index)?([^".]*)\.html/\/libdocument\/\2/g' "$html" \
        ...
        | sed -E 's/ &#124;$//' \
        | sed -E 's/<div class="summary">/<div class="summary"><a class="page-scroll btn btn-link" href="\/libdocument"><i class="fa fa-anchor"><\/i><br \/>Overview<\/a><br \/>/' \
